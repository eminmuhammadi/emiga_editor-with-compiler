...
function handleResult(data) {
  ...
  console.log("Cavabı kompilə etmək üçün " + (timeEnd - timeStart) + " ms gözləməli oldun.");
  ...
  $statusLine.html(`${status.description}, ${time}, ${memory}`);
      ...
      var translate = document.getElementById("statusLine").innerHTML; 
      var a1 = translate.replace("In Queue", "Sırada");
      document.getElementById("statusLine").innerHTML = a1;


      var translate = document.getElementById("statusLine").innerHTML; 
      var a2 = translate.replace("Processing", "Prosesləşdirilir");
      document.getElementById("statusLine").innerHTML = a2;


      var translate = document.getElementById("statusLine").innerHTML; 
      var a3 = translate.replace("Accepted", "Qəbul edildi");
      document.getElementById("statusLine").innerHTML = a3;


      var translate = document.getElementById("statusLine").innerHTML; 
      var a4 = translate.replace("Wrong Answer", "Səhv cavab");
      document.getElementById("statusLine").innerHTML = a4;


      var translate = document.getElementById("statusLine").innerHTML; 
      var a5 = translate.replace("Time Limit Exceeded", "Vaxt limiti aşdı");
      document.getElementById("statusLine").innerHTML = a5;


      var translate = document.getElementById("statusLine").innerHTML; 
      var a6 = translate.replace("Compilation Error", "Kompilsasiya zamanı xəta yarandı");
      document.getElementById("statusLine").innerHTML = a6;


      var translate = document.getElementById("statusLine").innerHTML; 
      var a7 = translate.replace("Runtime Error (SIGSEGV)", "Kompilsasiya zamanı xəta yarandı (SIGSEGV)");
      document.getElementById("statusLine").innerHTML = a7;


      var translate = document.getElementById("statusLine").innerHTML; 
      var a8 = translate.replace("Runtime Error (SIGXFSZ)", "Kompilsasiya zamanı xəta yarandı (SIGXFSZ)");
      document.getElementById("statusLine").innerHTML = a8;


      var translate = document.getElementById("statusLine").innerHTML; 
      var a9 = translate.replace("Runtime Error (SIGFPE)", "Kompilsasiya zamanı xəta yarandı (SIGFPE)");
      document.getElementById("statusLine").innerHTML = a9;


      var translate = document.getElementById("statusLine").innerHTML; 
      var b1 = translate.replace("Runtime Error (SIGABRT)", "Kompilsasiya zamanı xəta yarandı (SIGABRT)");
      document.getElementById("statusLine").innerHTML = b1;


      var translate = document.getElementById("statusLine").innerHTML; 
      var b2 = translate.replace("Runtime Error (NZEC)", "Kompilsasiya zamanı xəta yarandı (NZEC)");
      document.getElementById("statusLine").innerHTML = b2;


      var translate = document.getElementById("statusLine").innerHTML; 
      var b3 = translate.replace("Runtime Error (Other)", "Kompilsasiya zamanı xəta yarandı (Other)");
      document.getElementById("statusLine").innerHTML = b3;


      var translate = document.getElementById("statusLine").innerHTML; 
      var b4 = translate.replace("Internal Error", "Daxili xəta yarandı");
      document.getElementById("statusLine").innerHTML = b4;
...
function run() {
  ...
  $.ajax({
    ...
    success: function(data, textStatus, jqXHR) {
      console.log(`Sənin təqdimat tokenin : ${data.token}`);
      if (WAIT == true) {
        handleResult(data);
      } else {
...
var correctCaptcha = function(response) { 
    document.getElementById("sourceEditor").style.height = "42%";
    alert("Uğurlu bir şəkildə robot olmadığınızı təsdiq etdiniz\nKopyala düyməsindən istifadə edərək keçidi əməkdaşlarınla paylaşmağı unutma :)")
    ...
    var selectLanguageBtn = document.getElementById("selectLanguageBtn");
    if (selectLanguageBtn.style.display === "none") {
        selectLanguageBtn.style.display = "block";
    } else {
        selectLanguageBtn.style.display = "none";
    }

    var runBtn = document.getElementById("runBtn");
    if (runBtn.style.display === "none") {
        runBtn.style.display = "block";
    } else {
        runBtn.style.display = "none";
    }

    var start_all = document.getElementById("start_all");
    if (start_all.style.display === "none") {
        start_all.style.display = "block";
    } else {
        start_all.style.display = "none";
    }

$(document).ready(function() {

  console.log("Developed by Emin Muhammadi");
  ...
  $insertTemplateBtn.click(function(e) {
    if (!sourceEditor.isClean() && confirm("Ciddisən? Bütün yazdıqların silinəcək")) {
      setEditorMode();
      insertTemplate();
    }
  });
  ...
  $("body").keydown(function(e){
    ...
    if (keyCode == 120) { // F9
      ...
      e.preventDefault();
      var url = prompt("URL-i daxil et:", BASE_URL);
      if (url != null) {
        url = url.trim();
      }
      if (url != null && url != "") {
