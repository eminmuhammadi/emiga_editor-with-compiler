...
<body onload="init()" style="background-color: #DDDCD8;">  
  <div id="userlist">
  <div id="brand"><h4 id="lang_name"><?php echo $lang_name;?></h4></div>  
  </div>
  ...
  <input id="url_id" type="text" class="form-control" readonly="On" value=""> 
    ...
    <script src="app-userlist.js"></script>
    <script src="app.min.js"></script>    
  <script>
    function init() {
      var config = {
      <?php require_once(realpath($_SERVER["DOCUMENT_ROOT"]) .'/config.php'); ?>
      };
